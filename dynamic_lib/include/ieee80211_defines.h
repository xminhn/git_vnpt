...
#define VNPT_2MESHID_LEN                  12   /* meshID + vMeshID*/
...
/* VNPT Band Steering Pre-Assoc modification start */
    IEEE80211_MSG_VNPTT_PREASSOC,       	/* VNPT Band Steering Pre Assoc debug */
...
static inline const char * msg_type_to_str (int msg_type) {
    ...
    switch (msg_type) {
        ...
        case IEEE80211_MSG_CBS:
            return "CBS";
        /* VNPT Band Steering Pre-Assoc modification start */
        case IEEE80211_MSG_VNPTT_PREASSOC:
            return "VNPTT_PREASSOC";
        /* VNPT Band Steering Pre-Assoc modification end */
        default:
            return "UNSPECIFIED";
    }
