...
typedef enum ieee1905TlvType_e {
    ...
    IEEE1905_TLV_TYPE_VNPT_RENEW_SESSION_ID_OLD = 0xA3, // VNPT Session ID
    ...
    IEEE1905_TLV_TYPE_VNPT_RENEW_SESSION_ID = 0xF1, // VNPT Session ID
    IEEE1905_TLV_TYPE_ERROR = 0xF2,
